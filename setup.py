...
setup(name='pomsimulator',
      ...
      package_data={
        "pomsimulator": ["pomsimulator/inputs/W_Set_PBE_test/*out",
                         "pomsimulator/inputs/W_Set_PBE_molfiles/*mol",
                         "pomsimulator/utilities/np_IM_test.csv",
                         "pomsimulator/outputs/",]})
